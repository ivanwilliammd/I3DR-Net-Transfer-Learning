...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        ...
        self.pp_dir_preq = '../../../LIDC-Malignancy-Numpy'
        ...
        self.pp_data_path = '../LIDC-Malignancy-Numpy/{}'.format(self.pp_name)
        ...
        # self.num_epochs = 50
        self.num_epochs = 100
        # self.num_train_batches = 10 if self.dim == 2 else 10
        self.num_train_batches = 200 if self.dim == 2 else 200
        self.batch_size = 32 if self.dim == 2 else 25
