...
def load_dataset(cf, logger, subset_ixs=None):
    ...
    for ix, pid in enumerate(pids):
        # for the experiment conducted here, texture scores are converted into 0-2: >3 groundglass, >1 subsolid, 1 solid
        targets = [2 if ii > 3 else 1 if ii>1 else 0 for ii in class_targets[ix]]
