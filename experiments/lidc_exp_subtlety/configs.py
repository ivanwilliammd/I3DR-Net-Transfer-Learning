...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        ...
        self.pp_data_path = '../LIDC-Texture-Numpy/{}'.format(self.pp_name)
        ...
        self.num_epochs = 100
        # self.num_train_batches = 4 if self.dim == 2 else 4
        self.num_train_batches = 115
        ...
        self.class_dict = {1: 'nonsolid', 2: 'solid'}  # 0 is background.
        self.patient_class_of_interest = 2  # patient metrics are only plotted for one class.
        self.ap_match_ious = [0.1]  # list of ious to be evaluated for ap-scoring.

        self.model_selection_criteria = ['solid_ap', 'nonsolid_ap'] # criteria to average over for saving epochs.
