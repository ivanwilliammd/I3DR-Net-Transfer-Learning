...
def load_dataset(cf, logger, subset_ixs=None):
    ...
    for ix, pid in enumerate(pids):
        ...
        # for the experiment conducted here, texture scores are converted into 0-2: solid score 5 (1), groundlgass and subsolid score <5 (0)
        targets = [1 if ii >= 5 else 0 for ii in class_targets[ix]]
...
class BatchGenerator(SlimDataLoaderBase):
    ...
    def generate_train_batch(self):
        ...
        # maybe error because at folds1, need one of each class
